...
- **2026-09-17**: v5.2.0 - Added `customChatClient`, to replace the bundled AWS transport with your own. TypeScript: `GetTranscriptResult.NextToken` is now optional, so strict-mode consumers assigning it to `string` must widen to `string | undefined`
